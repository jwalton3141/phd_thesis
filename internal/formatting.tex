...
% Colour statements
\algrenewcommand\algorithmicfor{{\color{title-blue}for}}
\algrenewcommand\algorithmicend{{\color{title-blue}end}}
\algrenewcommand\algorithmicif{{\color{title-blue}if}}
\algrenewcommand\algorithmicelse{{\color{title-blue}else}}
\algrenewcommand\algorithmicthen{{\color{title-blue}then}}
\algrenewcommand\algorithmicdo{{\color{title-blue}do}}

% Create better for command
\algnewcommand\algorithmicto{{\color{title-blue}to}}
