...
\caption{Summaries of the three flocking sequences analysed in this chapter.
    ...
    flocks are all highly polarized and move at similar speeds.}
...
\begin{figure}[tbp]
  ...
  sequence one. The realised flock appears cohesive and dynamic.}
  \label{fig:seq_1_traj}
\end{figure}
\begin{figure}[tbp]
  \includegraphics{seq_2_traj.pdf}
  \caption{The movement of sheep in the second sequence recorded. These
  trajectories correspond to those illustrated in \cref{fig:sheep_frame}.}
...
\begin{figure}[tbp]
  ...
  flock goes through larger changes in direction than that seen in sequences
  one and two.}
