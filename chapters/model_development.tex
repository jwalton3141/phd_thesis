...
\begin{figure}[tb]
    ...
    section. \subref{fig:vicsek_weight} Visualising the Vicsek interaction, parameterised by
    the interaction radius $r$, as detailed in \cref{eq:vicsek_interaction}.
    \subref{fig:power_weight} The power-law weighting (\cref{eq:power_law_interaction}) is
