...
In this model the closer the neighbour to agent $i$, the more influence it has over agent
...
As with the power-law weighted model, here the influence which neighbour $j$ exerts over
agent $i$ is inversely related to their distance apart.
...
\begin{figure}
    ...
    \caption{Visualising how interaction strength decays with distance for the three
        considered interaction rules. From left to right the interactions represented are:
        the Vicsek model (\cref{eq:vicsek_interaction}), the power-law weighted
        interaction (\cref{eq:power_law_interaction}), the Gaussian weighted interaction
